...
export function getDefaultBrandStandards(): BrandStandards {
  return {
    ...
    hotelInfo: {
      ...
      phone: '',
      restaurants: [
        { name: 'DOSA', cuisine: '韓式精緻料理 Omakase', positioning: '米其林背景韓式套餐，慶祝與目的地型高端用餐。臺北首創韓式 Omakase 概念，市場類別獨特。品牌高度象徵 (Brand Halo)。' },
        { name: 'Akira Back', cuisine: '現代日式料理（明星主廚）', positioning: '國際名廚現代日式料理，高端社交與話題餐廳。全球名廚品牌加持，話題與流量引擎 (Destination Driver)。' },
        { name: 'Rough Cuts (Grill)', cuisine: '現代奢華牛排館', positioning: '以火候與食材為核心，商務與慶祝型牛排館。高毛利核心 (Margin Powerhouse)。品酒晚宴、威士忌活動與精品品牌合作。' },
        { name: 'Chinese Restaurant (TBD)', cuisine: '高端現代中餐', positioning: '精緻現代中餐，商務與家庭宴請場域。高端宴請場域 (Prestige Occasion Venue)，包廂與宴請需求高。' },
        { name: '5F All Day Dining (Buffet)', cuisine: '高端自助餐', positioning: '符合台灣市場偏好的高端自助餐。流量與場景核心 (Volume + Occasion Anchor)，主打高端海鮮與季節主題美食節。' },
        { name: 'The Thea (Lobby Lounge)', cuisine: '下午茶與日間社交', positioning: '植感下午茶與優雅日間社交空間。品牌氛圍核心 (Brand Atmosphere Anchor)，季節主題下午茶與精品品牌聯名。' },
        { name: 'NTD (Italian Eatery)', cuisine: '高端休閒義式料理', positioning: '輕鬆高質感義式餐廳。流量入口 (Volume Driver)，結合 Aperitivo 餐酒文化與手工義大利麵。' },
      ],
      bars: [
        { name: 'Chinese Restaurant Bar', concept: '文化型精釀酒吧', positioning: '穀物與亞洲元素為主軸的精緻調酒空間。以茶、白酒、草本與米酒為元素的特色調酒，導入茶搭餐 (Tea Pairing)。' },
        { name: 'Steakhouse Bar', concept: '高端社交酒吧', positioning: '經典調酒與威士忌為核心。牛排館的自然延伸，適合葡萄酒與威士忌搭配。' },
      ],
      gmName: '',
      gmTitle: '總經理',
      mediaContacts: [
    ...
    brand: {
      ...
      fbPhilosophy: '故事食譜 (A Recipe for Stories) — 故事 (Story)、場景 (Set)、靈魂 (Soul)',
